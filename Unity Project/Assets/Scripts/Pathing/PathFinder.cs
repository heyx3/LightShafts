...
public class PathFinder<N> where N : Node
{
    ...
    public void CalculatePathTree(float maxSearchCost, bool onlySearchToDestination, bool setEnd = false)
    {
        ...
        while (!NodesToSearch.IsEmpty)
        {
            ...
            //"goesOn" holds whether or not there is another un-searched Node connected to the current one.
            goesOn = false;
            //"noBranches" is true if "goesOn" is true,
            //but none of the Nodes are actually reachable due to limits on the search cost.
            noBranches = true;
            ...
            //   check this Node as a potential destination Node in case the real destination is too far away.
